<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoCaoTonKho.aspx.cs" Inherits="QuanLyGaraOto.Reports.BaoCaoTonKho" %>
...
<body>
    ...
    <asp:scriptmanager runat="server"></asp:scriptmanager>
        <rsweb:ReportViewer ID="TonKhoReportViewer" runat="server" ZoomMode="PageWidth" BackColor="White"
